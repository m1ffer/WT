...
public class TaskManager {
	...
	private static String makeJson(String taskId, String taskName, String taskStatus){
		return String.format("{\"taskId\":\"%s\",\"taskName\":\"%s\",\"taskStatus\":\"%s\"}",
        ...
        return HttpRequest.newBuilder()
                ...
                .POST(
                        HttpRequest.BodyPublishers
                                .ofString(makeJson(taskId, taskName, taskStatus))
                )
                .build();
	}
