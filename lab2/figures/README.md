...
You may replace any abstract method given in the `Figure` class
with some implementation, when it suits a case well.
You can also add your own method(s) to the `Figure` class.
